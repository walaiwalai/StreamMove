...
import com.sh.upload.model.body.BlockStreamBody;
...
public class BiliWorkUploadServiceImpl implements PlatformWorkUploadService {
    ...
    @Override
    public boolean finishChunksUploadOnWeb(String videoName, Integer totalChunks, Map<String, String> extension) {
    ...
    @Override
    public boolean postWorkOnWeb(String streamerName, List<RemoteSeverVideo> remoteSeverVideos,
    ...
    @Override
    public boolean uploadChunkOnClient(String uploadUrl, File targetFile, Integer chunkNo, Integer totalChunks,
    ...
    public boolean postWorkOnClient(String streamerName, List<RemoteSeverVideo> remoteSeverVideos,
        ...
        String accessToken = configManager.getUploadPersonInfo().getAccessToken();
