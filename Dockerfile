...
ENTRYPOINT ["sh", "-c", "python3 replace_placeholders.py && java -Dfile.encoding=utf-8 -Duser.timezone=GMT+08 -Dspring.profiles.active=prod -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/admin/stream/dump/ -Xms1g -Xmx1g -jar /home/admin/stream/sh-start-1.0-SNAPSHOT.jar --spring.config.location=file:/home/admin/stream/application-prod.properties"]